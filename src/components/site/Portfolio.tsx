    ...
    <section id="portfolio" className="relative py-32 bg-secondary/30">
      <div className="container-luxe">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          ...
          <p className="text-muted-foreground max-w-md" data-reveal="right" data-reveal-delay="140">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {projects.map((p, i) => (
            ...
            >
              <article className="motion-card group relative rounded-3xl overflow-hidden bg-card border border-border/60 hover:-translate-y-2 hover:border-gold/40 hover:shadow-gold-soft transition-all duration-500">
                ...
                <div className="absolute inset-x-0 bottom-0 p-8 transition-transform duration-500">
                  <div className="flex items-end justify-between gap-4">
                    <div>
                      ...
                      <p className="inline-block text-sm font-semibold text-gold px-3 py-1 rounded-full border border-gold/30 bg-gold/10">
                        {p.result}
                      </p>
                      <p className="text-sm text-muted-foreground mt-3 max-h-0 group-hover:max-h-32 overflow-hidden transition-all duration-500 opacity-0 group-hover:opacity-100">
                        {p.desc}
                      </p>
                    </div>
