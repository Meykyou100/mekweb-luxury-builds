          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="relative mx-auto mb-8 w-24 h-24">
                ...
                <div className="relative w-24 h-24 rounded-full bg-card border border-gold/30 grid place-items-center shadow-gold-soft group-hover:border-gold group-hover:scale-105 transition-all duration-500">
                  <s.icon className="w-9 h-9 text-gold" strokeWidth={1.5} />
                </div>
                <span className="absolute -top-2 -right-2 w-9 h-9 rounded-full bg-gradient-gold text-primary-foreground text-sm font-display font-bold grid place-items-center shadow-gold-soft">
                  {s.n}
                </span>
              </div>
